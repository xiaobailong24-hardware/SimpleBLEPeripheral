...
/* UART Events */
#define HAL_UART_RX_FULL         0x01   //´®¿Ú½ÓÊÕ»º³åÇøÂú
#define HAL_UART_RX_ABOUT_FULL   0x02   //´®¿Ú½ÓÊÕ»º³åÇø½«Âú
#define HAL_UART_RX_TIMEOUT      0x04   //´®¿Ú½ÓÊÕ
#define HAL_UART_TX_FULL         0x08   //´®¿Ú·¢ËÍ»º³åÇøÂú
#define HAL_UART_TX_EMPTY        0x10   //´®¿Ú·¢ËÍ»º³åÇø¿Õ
