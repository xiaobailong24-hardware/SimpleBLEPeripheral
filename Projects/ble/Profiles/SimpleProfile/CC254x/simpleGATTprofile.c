...
// Simple Profile Characteristic 6 Properties   ¿É¶Á¿ÉÐ´
...
static uint8 simpleProfileChar6UserDesp[17] = "PulseSensor";
...
static uint8 simpleProfileChar7[SIMPLEPROFILE_CHAR7_LEN] = {1,0,0,0,0,0,0,0};
